  ...
  return (
    <section id="currency-converter" className="scroll-mt-24 py-12">
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="bg-slate-50 p-6 md:p-8 border-b border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="bg-blue-600 p-2 rounded-lg text-white">
              <RefreshCw size={24} className={loading ? 'animate-spin' : ''} />
            </div>
            <div>
              <h2 className="text-xl font-bold text-slate-900">Universal Currency Converter</h2>
        ...
        <div className="p-6 md:p-8">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-end gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col gap-2">
                <select
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 text-sm font-bold text-slate-800 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none"
                >
                  {currencies.map(c => (
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-4 font-bold text-slate-800 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center pb-2">
              <button
                onClick={handleSwap}
                className="p-3 bg-white border border-slate-200 rounded-full hover:bg-slate-50 transition-colors shadow-sm text-blue-600 active:scale-95"
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-xl py-3 px-4 flex items-center justify-between">
                  <span className="text-blue-900 font-black text-xl">
                    {toSymbol} {convertedAmount.toLocaleString(undefined, { maximumFractionDigits: 2 })}
                  </span>
                  <span className="text-[10px] font-bold text-blue-500 uppercase">{toCurrency}</span>
                </div>
              </div>
            </div>
          </div>

          <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-slate-100 pt-8">
            <p className="text-sm text-slate-500 leading-relaxed text-center sm:text-left">
